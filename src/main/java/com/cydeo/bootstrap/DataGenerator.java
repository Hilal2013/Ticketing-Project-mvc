...
public class DataGenerator implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        //create some roles and put in the DB
        //create users and put in the DB
        RoleDTO adminRole = new RoleDTO(1L, "Admin");
        RoleDTO managerRole = new RoleDTO(2L, "Manager");
        RoleDTO employeeRole = new RoleDTO(3L, "Employee");

        //these objects arent in the database
        //   RoleService rs=new RoleServiceImpl();
        //rs.save(adminRole);
        //Spring doesnt like new keyword=>tight coupling//you create object by yourself and manage it
//How im gonna do loose coupling
        //we need to implement IoC principle here
